...
export default function Register() {
  const { register, loginWithGoogle, closeModals } = useAuth();
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative transform overflow-hidden rounded-3xl bg-gray-900 border border-gray-700 shadow-2xl transition-all w-full max-w-md">
          ...
          <div className="px-8 py-8 text-center">
            ...
            <p className="text-gray-400">Start your cybersecurity journey</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-200"
              ...
              <div className="space-y-4 pt-2">
                <button 
                  type="submit" 
                  disabled={loading} 
                  className="w-full py-3 px-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold rounded-xl transition-all duration-200 transform hover:scale-[1.02] disabled:hover:scale-100 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                >
                  {loading ? (
